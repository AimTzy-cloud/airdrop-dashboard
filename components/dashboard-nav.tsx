...
export function DashboardNav({ username, userId, profilePicture }: DashboardNavProps) {
  ...
  const diceBearUrl = useMemo(() => `https://api.dicebear.com/7.x/initials/svg?seed=${username || "User"}`, [username])
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <div className="flex items-center ml-4 pl-4 border-l border-gray-700 cursor-pointer">
                <Avatar className="h-8 w-8 mr-2">
                  {/* Direct image element for debugging */}
                  <img
                    src={profilePicture || diceBearUrl}
                    alt={username}
            ...
            <DropdownMenuContent align="end" className="w-56 bg-[#1a1f2e] border-gray-700">
              ...
              <DropdownMenuItem disabled className="opacity-70 cursor-not-allowed text-white">
